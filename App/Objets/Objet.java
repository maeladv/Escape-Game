...
public class Objet {
    ...
    public Objet(String name, Rectangle hitbox, Inventaire inventaire, Item itemToInteract, Runnable onCollision) {
        this.name = name;
        this.hitbox = hitbox;
        this.inventaire = inventaire;
    ...
    public void trigger() {
        if (!alreadyTriggered && onCollision != null && itemToInteract != null && inventaire.contientItem(itemToInteract.getName())) {
            onCollision.run();
